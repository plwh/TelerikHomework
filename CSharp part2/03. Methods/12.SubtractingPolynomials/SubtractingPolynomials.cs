...
class SubtractingPolynomials
{
    ...
    static void Main()
    {
        ...
        int[] polynomialSubtraction = SubtractPolynomials(firstPolynomial, secondPolynomial);
        Console.Write("Result of polynomial subtraction:");
        PrintPolynomial(polynomialSubtraction);
        int[] polynomialMultiplication = MultiplyPolynomials(firstPolynomial, secondPolynomial);
        Console.Write("Result of polynomial multiplication:");
        PrintPolynomial(polynomialMultiplication);
    }
}
